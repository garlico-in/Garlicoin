...
bech32_templates = [
  ...
  ('grlc',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('grlc',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('grlc',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tgrlc',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tgrlc',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tgrlc',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rgrlc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rgrlc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rgrlc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tgrlc',   17, 32, False, False, False),
  ('rgrlc',  3,  1, False, False, False),
  ('grlc',   15, 41, False, False, False),
  ('tgrlc',    0, 16, False, False, False),
  ('rgrlc',  0, 32, True,  False, False),
  ('grlc',    0, 16, True,  False, False),
  ('tgrlc',    0, 32, False, True,  False),
  ('rgrlc',  0, 20, False, False, True)
]
